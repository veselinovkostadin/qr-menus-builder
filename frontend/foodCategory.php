...
$query = $db->prepare("SELECT products.*,restaurant.name as restaurant,categories.name as category FROM products JOIN categories ON category_id = categories.id
                              JOIN restaurant ON categories.menu_id = restaurant.id WHERE products.category_id = :categoryId and products.belongs_to = 1 and restaurant.UUID = :uuid");
$query->execute([":categoryId" => $_GET["categoryId"], ":uuid" => $_GET["UUID"]]);
...
<body>
     ...
     <div class="container mt-3">
          <div class="foodDivClass row mx-auto img-fluid">
     ...
     <div class="container mt-4">
          ...
          if (!empty($products)) {
               foreach ($products as $product) {
                    echo "<div class='container productCard leftShadow d-flex justify-content-center align-items-center mb-2'>
               <div class='row mh-100'>
                    ...
                    <div class='row'>
                         ...
                         <!-- Ogranichi go ova na max 50 karakteri -->
          ...
          <!-- <div class="container productCard rightShadow mt-2 d-flex justify-content-center align-items-center">
               <div class="row mh-100">

                    <div class="col-6 text-center ">
                         <p class="productName mb-0">Product 2</p> -->
          <!-- Ogranichi go ova na max 50 karakteri -->
          <!-- <p class="productDescription mb-1">Lorem ipsum dolor sit amet consectetur, adipisicing elit...</p>
                         <div class="row d-flex justify-content-between align-items-center">
                              <div class="seeMoreBtn col-6 ms-2 d-inline-block">
                                   <a href="./foodProduct.php" class="">See more</a>
                              </div>
                              <div class="col-5 me-0 d-inline-block">
                                   <p class="m-0 fs-4">$$$$</p>
                              </div>
                    ...
                    <div class="col-6 d-flex justify-content-center align-items-center">
                         <img src="./images/salad01.png" class="img-fluid productImg" alt="">
                    </div>
               </div>
     ...
     <div class="container d-flex justify-content-end sticky-bottom my-2">
          <div class="col-5 backButton">
               <a href="./foodSection.php?UUID=<?= $_GET['UUID'] ?>"><span>Back</span></a>
          </div>
     </div>
